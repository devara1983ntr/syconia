...
| [M1-T009](./tasks/M1/M1-T009.md) | Primitives batch 2 — overlays & navigation (Badge, Tooltip, Dropdown, Modal, Drawer, BottomSheet, Tabs, Toast, Alert, Pagination, Breadcrumb) | COMPLETE | task file Completion Evidence: overlay core (ESC-topmost stack per GESTURES §62 · focus trap/return · ref-counted scroll lock · Portal · §9 scrim) · 11 primitives with dialog semantics (role/aria-modal/labelled) + scrim/X/ESC close law · sheet ≤767px-only w/ honest auto-dismiss · Tooltip 300ms + aria-describedby + ESC · Dropdown full APG menu model · Tabs ARIA + roving + arrows · Toast role=status region + 4s pause-on-hover/focus remaining-time math · D-011 register (scrim 0.56 token wins over SCREENS 40% · popover z rung mapping · MODAL_WIDTH/SHEET_MAX_HEIGHT/MENU_MAX_HEIGHT pinned) · 79 new tests (275/275) incl. axe zero-critical matrices + keyboard journeys · 40 new stories (92 total, build green; preview mounts real MotionProvider+ToastProvider) · jest-dom 6.9.1 pinned + vitest setupFiles · G-7/G-8 PASS · commit `feat(ui): primitives batch 2 — overlays & navigation with overlay core + Storybook gallery (M1-T009)` |
...
**Totals:** 70 tasks — 12 COMPLETE · 54 NOT_STARTED · 4 BLOCKED (M2-T008/T009 ← B-001; M5-T006 ← B-003; M5-T007 ← B-002). Gates: M0 PASS · M2 BLOCKED(B-001) · M1/M3/M4/M5 NOT_STARTED.
