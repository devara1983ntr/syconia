...
| **M1-FOUNDATION** | Repo scaffold, tokens/primitives, middleware (age gate + headers), global chrome, age gate, public routing, legal pages, error/offline/404, test harness | M1-T001…T018 | M0-GATE PASS (+ [DA-GATE](./gates/DA-GATE.md) PASS WITH CONDITIONS — production asset pack staged in `branding/`; condition C-1 closes before M1-GATE) | App shell with branded chrome, age-gate enforced server-side, all public routes scaffolded, E2E smoke green | [M1-GATE](./gates/M1-GATE.md) |
